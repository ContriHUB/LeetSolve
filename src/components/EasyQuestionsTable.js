				...
				<Table>
					...
					<TBody>
						{data["stat_status_pairs"].map((que, index) => {
							if (!(que["difficulty"]["level"] == 1)) {
								//if not easy (level 1) then return null
								return null;
							}
...
export default EasyQuestionsTable;