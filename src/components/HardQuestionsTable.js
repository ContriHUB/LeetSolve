				...
				<Table>
					...
					<TBody>
						{data["stat_status_pairs"].map((que, index) => {
							if (!(que["difficulty"]["level"] == 3)) {
								//if not hard (level 3) then return null
								return null;
							}
...
export default HardQuestionsTable;